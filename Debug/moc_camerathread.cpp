...
QT_MOC_LITERAL(1, 13, 8), // "sigImage"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 7), // "QImage&"
QT_MOC_LITERAL(4, 31, 8) // "sigError"

    },
    "CameraThread\0sigImage\0\0QImage&\0sigError"
};
...
void CameraThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigImage((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CameraThread::sigImage)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (CameraThread::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CameraThread::sigError)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void CameraThread::sigImage(QImage & _t1)
{
...
// SIGNAL 1
void CameraThread::sigError(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
